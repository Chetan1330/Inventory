  ...
  $.fn.tablemanager = function (options = null) {
    ...
    if (options !== null) {
      ...
      if (
        ...
        // div num rows
        var numrowsDiv =
          '<div id="for_numrows" class="for_numrows" style="display: inline;"><label style="font-size: 14px;" for="numrows">' +
      ...
      if (options.appendFilterby === true || Table.hasClass("tableFilterBy")) {
        ...
        var filterbyDiv =
          '<div id="for_filter_by" class="for_filter_by" style="display: inline;"><label style="font-size: 14px;" for="filter_by">' +
    ...
    function updateDisplayedData() {
      console.log(selectedColumns,eads.eq(index).text(),'showRow',showRow)
      rows.each(function () {
        var row = $(this);
